...
public class SquareFrame extends JFrame {
     ...
     * grid
     * @return JPanel;
     *      the container that holds every grid computed
     */
    ...
    /**
     * allows other classes to use restart page panel that has been added to frame
     * @return JPanel
     *      returns restart page panel that is contained within main frame
     */
     ...
     * @return JPanel
     *      returns notify bar panel that is contained within main frame
     */
     ...
     * @return JPanel
     *      returns start page panel that is contained within main frame
     */
     ...
     * example of when this is to be called is when a player want to restart game
     * after a game over has been encountered.
     */
